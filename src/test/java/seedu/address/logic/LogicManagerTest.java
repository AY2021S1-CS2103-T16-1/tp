...
import static seedu.address.commons.core.Messages.MESSAGE_INVALID_VENDOR_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonVendorListStorage addressBookStorage =
                new JsonVendorListStorage(temporaryFolder.resolve("addressBook.json"));
     ...
     */
    private static class JsonAddressBookIoExceptionThrowingStub extends JsonVendorListStorage {
        private JsonAddressBookIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }

        @Override
        public void saveVendorList(ReadOnlyVendorList addressBook, Path filePath) throws IOException {
